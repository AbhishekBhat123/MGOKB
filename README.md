...
<form id="invoice-form">
    ...
    <div id="icnbFields" style="display: none;">
        <hr>
        <h4 class="mb-3 text-center text-primary" id="detailsHeading">Invoice Cum Bil of Supply</h4>
        <div class="row g-3 mb-3">
            ...
            <div class="col-md-4">
                ...
                <select class="form-select managed-dropdown" id="gstin" name="gstinSelected" data-option-type="gstin">
                    ...
                    <option value="Add New" class="add-new-option">Add New</option>
                    <option value="Manage" class="manage-option">Manage...</option> </select>
        ...
        <div class="row g-3 mb-3 align-items-end bg-light p-3 rounded border">
            ...
            <div class="col-md-3">
                ...
                <select class="form-select managed-dropdown" id="itemDescription" data-option-type="itemDescription"> <option value="" selected disabled>-- Select --</option>
